...
#'
#' @examples
#' my_categories <- bwr_cat_get(project_id = 12334534)
bwr_cat_get <- function(token = Sys.getenv("BW_TOKEN"),
                          project_id = NULL) {
...
#'
#' @examples
#' bwr_cat_create(project_id = 12423432, name = "Quick test cat", children = list(list(name = "category one", id = 234234), list(name = "category 2")))
bwr_cat_create <- function(token = Sys.getenv("BW_TOKEN"),
                             project_id = NULL,
                             name = NULL,
                           children = NULL) {
